 ...
 db_connection conn = new db_connection();
   Connection con = conn.get_connection();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 153), 3));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\Fauni\\Desktop\\user(2).png")); // NOI18N
        ...
        password.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 153, 153), 1, true));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Login_query = "Select * from sample where `username`=? && `password` =?";
